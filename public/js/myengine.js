...
//************** картриджи
$("#reg_cart").on('click', function (event) {
            $.ajax({
	    type: 'GET',
            url: '/regcart',
            success: function (response) {
...
$("#on_storage").on('click', function (event) {
            $.ajax({
	    type: 'GET',
            url: '/getcart',
            success: function (response) {
...
$("#on_fill").on('click', function (event) {
            $.ajax({
	    type: 'GET',
            url: '/fillcart',
            success: function (response) {
...
$("#give_cart").on('click', function (event) {
            $.ajax({
	    type: 'GET',
            url: '/workcart',
            success: function (response) {
...
$("#kill_cart").on('click', function (event) {
            $.ajax({
	    type: 'GET',
            url: '/killcart',
            success: function (response) {
...
$("#report_storage").on('click', function (event) {
            $.ajax({
	    type: 'GET',
            url: '/on_storage',
            success: function (response) {
...
$("#mbody").keyup(function(event) {
    ...
    if (event.keyCode === 13) {
	    ...
	    let proc = $("#mod_context").data('modal');
	    let otd = $("#sel_otd option:selected").text(); 
            $.ajax({
	    type: 'POST',
            url: '/reg_new_cart',
	    data: {id_name: id_name, id_print: id_print, sh_code: sh_code, proc: proc, otd: otd},
            success: function (response) {
	     if(response=="errstor"){
		alert("Картридж уже на складе!");
		return; 
    	    }
	     if(response=="nullcart"){
		alert("Нет такого картриджа! Проверьте, что добавили и не списали.");
		return; 
    	    }
    
	     if(response=="errfill"){
		alert("Картридж уже на заправке!");
		return; 
    	    }
	     if(response=="existscart"){
		alert("Картридж уже есть в базе!");
		return; 
    	    }
	    ...
	    alert('Что-то нет так. Бывает. Обновите страницу и попробуйте еще раз.');
	    }
        });
